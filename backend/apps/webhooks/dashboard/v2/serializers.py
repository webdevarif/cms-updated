...
class WebhookDashboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Webhook
        fields = [
            'id', 'name', 'description', 'url', 'method', 'secret',
            'verify_ssl', 'event_types', 'is_active',
            'delivery_count', 'last_triggered_at', 'success_rate',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at', 'delivery_count', 'last_triggered_at', 'success_rate']
...
class WebhookDeliveryDashboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'webhook', 'webhook_name', 'webhook_url', 'event_type', 'payload',
