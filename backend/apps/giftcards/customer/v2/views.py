...
from .serializers import CustomerGiftCardSerializer, CustomerGiftCardPurchaseSerializer, CustomerGiftCardRedeemSerializer
    ...
    def purchase(self, request):
        ...
        try:
            ...
            gift_card = GiftCardService.create_gift_card(
                ...
                recipient_email=serializer.validated_data.get('recipient_email', request.user.email),
                recipient_name=serializer.validated_data.get('recipient_name', ''),
                sender_name=serializer.validated_data.get('sender_name', request.user.get_full_name()),
