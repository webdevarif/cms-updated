...
from .views import (
    ProductPublicViewSet, ProductCategoryPublicViewSet, CartPublicViewSet,
    CollectionPublicViewSet, CustomerProfilePublicViewSet, ReviewPublicViewSet
)
...
router.register(r'customer-profiles', CustomerProfilePublicViewSet, basename='public-customer-profiles')
