...
class LanguageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Language
        fields = [
            'id', 'code', 'name', 'name_native', 'is_active',
            'is_rtl', 'flag_icon', 'created_at', 'updated_at'
        ]
...
class TranslationKeySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'key', 'description', 'category', 'is_active',
...
class TranslationDashboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Translation
        fields = [
            'id', 'store', 'store_name', 'language', 'language_code', 'language_name',
            'translation_key', 'key_name', 'key_description',
            'value', 'is_active', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'language_code', 'language_name', 'key_name', 'key_description', 'store_name', 'created_at', 'updated_at']
