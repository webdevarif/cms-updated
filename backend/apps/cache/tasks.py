...
from .services import CacheMonitor, CacheService, CacheWarmupService
...
def cleanup_expired_cache():
    ...
    try:
        ...
        count, _ = CacheEntry.objects.filter(expires_at__lt=timezone.now()).delete()
...
def schedule_cache_monitoring():
    ...
    try:
        ...
        current_app.send_task(
            "apps.cache.tasks.schedule_cache_monitoring", countdown=300  # Every 5 minutes
        )
