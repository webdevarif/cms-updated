...
from apps.themes.models import Theme, Template, Layout, StyleClass, Typography, ThemeMarketplace
from apps.themes.services import ThemeRenderingService, ThemeManagementService, ThemeMarketplaceService
from .serializers import (
    ThemeDashboardSerializer, TemplateDashboardSerializer, LayoutDashboardSerializer,
    StyleClassDashboardSerializer, TypographyDashboardSerializer, ThemeMarketplaceSerializer,
    ThemeAnalyticsSerializer, BulkTemplateUpdateSerializer
)
...
class ThemeDashboardViewSet(viewsets.ModelViewSet):
    ...
    def activate(self, request, pk=None):
        ...
        try:
            ...
            return Response({
                'message': f'Theme "{theme.name}" activated successfully for store'
            })
    ...
    def deactivate(self, request, pk=None):
        ...
        try:
            ...
            return Response({
                'message': f'Theme "{theme.name}" deactivated successfully'
            })
    ...
    def bulk_template_update(self, request):
        ...
        try:
            ...
            return Response({
                'message': 'Bulk template update completed',
    ...
    def purchase(self, request, pk=None):
        ...
        try:
            purchase_result = ThemeMarketplaceService.purchase_theme(
                marketplace_theme=marketplace_theme,
                user=request.user,
                store=request.store
            )
