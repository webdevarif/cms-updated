...
from .views import (
    DashboardProductViewSet, ProductCategoryDashboardViewSet, ProductVariantDashboardViewSet,
    DashboardInventoryViewSet, DashboardCollectionViewSet, CartDashboardViewSet,
    OrderDashboardViewSet, OrderItemDashboardViewSet, CouponCampaignDashboardViewSet,
    CouponDashboardViewSet, PaymentMethodDashboardViewSet, PaymentDashboardViewSet,
    CustomerProfileDashboardViewSet, ReviewDashboardViewSet
)
...
router.register(r'coupon-campaigns', CouponCampaignDashboardViewSet, basename='dashboard-coupon-campaigns')
router.register(r'coupons', CouponDashboardViewSet, basename='dashboard-coupons')
router.register(r'payment-methods', PaymentMethodDashboardViewSet, basename='dashboard-payment-methods')
router.register(r'payments', PaymentDashboardViewSet, basename='dashboard-payments')
router.register(r'customer-profiles', CustomerProfileDashboardViewSet, basename='dashboard-customer-profiles')
