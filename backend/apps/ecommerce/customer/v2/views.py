...
from .serializers import (
    ProductCustomerSerializer, ProductCategoryCustomerSerializer,
    CartCustomerSerializer, CartItemCustomerSerializer,
    CollectionCustomerSerializer, CustomerProfileCustomerSerializer,
    OrderCustomerSerializer, OrderItemCustomerSerializer,
    CouponCustomerSerializer, PaymentMethodCustomerSerializer, PaymentCustomerSerializer
)
...
class ReviewCustomerViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Review.objects.filter(
            user=self.request.user,
            parent__isnull=True  # Only top-level reviews, not replies
