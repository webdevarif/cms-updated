...
class PublicEntityActionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_public', 'allow_anonymous', 'interaction_count'
        ]
...
class PublicEntityInteractionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'action_name', 'action_slug', 'action_type', 'action_icon', 'action_color',
            'username', 'content_type', 'object_id', 'content_type_name',
            'value', 'rating', 'created_at'
        ]
        read_only_fields = fields
