...
class MediafileDashboardViewSet(viewsets.ModelViewSet):
    ...
    def bulk_upload(self, request):
        ...
        try:
            ...
            return Response({"uploaded": serializer.data, "errors": errors})
        except Exception as e:
    ...
    def bulk_delete(self, request):
        ...
        try:
            ...
            if store:
                deleted_count = MediaFile.objects.filter(id__in=file_ids, store=store).delete()[0]
            else:
                deleted_count = 0
    ...
    def bulk_move(self, request):
        ...
        try:
            ...
            if store:
                updated_count = MediaFile.objects.filter(id__in=file_ids, store=store).update(
                    folder_id=folder_id
                )
            else:
                updated_count = 0

            return Response({"message": f"Moved {updated_count} files successfully"})
        except Exception as e:
...
class MediafolderDashboardViewSet(viewsets.ModelViewSet):
    ...
    def bulk_delete(self, request, pk=None):
        ...
        try:
            ...
            return Response({"message": f"Deleted {deleted_count} items successfully"})
        except Exception as e:
