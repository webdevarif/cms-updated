...
class DashboardLogViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(summary="List system logs", description="Get paginated list of system logs")
    def list(self, request, *args, **kwargs):
        """List logs with filtering"""
        return super().list(request, *args, **kwargs)

    @extend_schema(summary="Create log entry", description="Create a new log entry")
    ...
    @extend_schema(summary="Get log statistics", description="Get statistics about log entries")
    ...
    @extend_schema(summary="Export logs", description="Export logs as CSV")
    @action(detail=False, methods=["get"])
    ...
    @extend_schema(summary="Clear old logs", description="Clear logs older than specified days")
