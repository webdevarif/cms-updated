...
def trigger_order_webhooks(sender, instance, created, **kwargs):
    ...
    event_data = {
        ...
        'subtotal': float(instance.subtotal) if hasattr(instance, 'subtotal') and instance.subtotal else None,
        'tax': float(instance.tax) if hasattr(instance, 'tax') and instance.tax else None,
        'shipping': float(instance.shipping) if hasattr(instance, 'shipping') and instance.shipping else None,
...
def trigger_product_webhooks(sender, instance, created, **kwargs):
    ...
    event_data = {
        ...
        'compare_at_price': float(instance.compare_at_price) if hasattr(instance, 'compare_at_price') and instance.compare_at_price else None,
        ...
        'weight': float(instance.weight) if hasattr(instance, 'weight') and instance.weight else None,
...
def trigger_post_webhooks(sender, instance, created, **kwargs):
    ...
    event_data = {
        ...
        'author': getattr(instance.author, 'email', '') if hasattr(instance, 'author') and instance.author else '',
        ...
        try:
            ...
            if old_instance.status != 'published':
                ...
                event_data = {
                    ...
                    'slug': getattr(instance, 'slug', ''),
                    'author': getattr(instance.author, 'email', '') if hasattr(instance, 'author') and instance.author else '',
                    'published_at': instance.published_at.isoformat() if hasattr(instance, 'published_at') and instance.published_at else timezone.now().isoformat()
                }
...
def trigger_form_submission_webhooks(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        event_data = {
            'id': str(instance.id),
            'form_name': getattr(instance.form, 'name', '') if hasattr(instance, 'form') and instance.form else '',
            'form_id': str(instance.form.id) if hasattr(instance, 'form') and instance.form else '',
            'submitted_at': instance.created_at.isoformat() if hasattr(instance, 'created_at') else timezone.now().isoformat(),
...
def trigger_user_webhooks(sender, instance, created, **kwargs):
    ...
    event_data = {
        ...
        'last_login': instance.last_login.isoformat() if hasattr(instance, 'last_login') and instance.last_login else None
    }
...
def trigger_notification_webhooks(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        event_data = {
            ...
            'recipient_email': getattr(instance.recipient, 'email', '') if hasattr(instance, 'recipient') and instance.recipient else '',
            'created_at': instance.created_at.isoformat() if hasattr(instance, 'created_at') else timezone.now().isoformat()
        }
