...
class GiftCardService:
    ...
    @staticmethod
    def create_gift_card(store, created_by, gift_card_type='digital', 
                         initial_balance=None, currency='USD', **kwargs):
        """
    ...
    def get_gift_card_analytics(store):
        ...
        return {
            ...
            'total_redeemed': str(queryset.filter(action='redeemed').aggregate(
