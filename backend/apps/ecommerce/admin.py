...
from .models import (
    ...
    Cart, CartItem, CustomerProfile, Inventory, Order, OrderItem,
    CouponCampaign, Coupon, PaymentMethod, Payment
)
...
class OrderItemAdmin(admin.ModelAdmin):
    list_display = ['order', 'product', 'product_sku', 'quantity', 'unit_price', 'total_price', 'created_at']
    list_filter = ['created_at']
...
class CouponCampaignAdmin(admin.ModelAdmin):
    list_display = ['name', 'store', 'discount_type', 'discount_value', 'is_active', 'starts_at', 'ends_at']
