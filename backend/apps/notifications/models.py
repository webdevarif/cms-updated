...
class NotificationType(models.TextChoices):
    ...
    ORDER_NEW_ORDER = 'order.new_order', 'New Order'
    ORDER_STATUS_UPDATED = 'order.status_updated', 'Order Status Updated'
    ...
    PRODUCT_LOW_STOCK = 'inventory.low_stock', 'Product Low Stock'
...
class NotificationPreference(models.Model):
    ...
    class Meta:
        ...
        ordering = ['store', 'user', 'notification_type']
...
class NotificationTemplate(models.Model):
    ...
    class Meta:
        ...
        ordering = ['store', 'notification_type', 'name']
