...
class RoleAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Role Information", {"fields": ("name", "permissions")}),
...
class UserPreferencesAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("UI Preferences", {"fields": ("theme", "language")}),
        ("Privacy", {"fields": ("show_email", "show_online_status")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class UserActivityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Activity", {"fields": ("store_user", "action", "details")}),
