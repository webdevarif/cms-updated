...
class CommentService:
    ...
    @staticmethod
    def create_comment(post, user, content, parent=None, user_ip=None, user_agent=None, referrer=None):
    ...
    def bulk_moderate_comments(comment_ids, action, moderator, reason=None):
        ...
        for comment_id in comment_ids:
            try:
                ...
                moderated_comment = CommentService.moderate_comment(comment, action, moderator, reason)
