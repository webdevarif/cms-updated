...
from .serializers import (
    CustomerFormTemplateSerializer, 
    CustomerFormSubmissionSerializer
)


class CustomerFormFilter(filters.FilterSet):
    """Filters for customer form templates"""
    status = filters.ChoiceFilter(choices=[('draft', 'Draft'), ('published', 'Published'), ('archived', 'Archived')])
