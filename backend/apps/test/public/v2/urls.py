...
from .views import TestPublicViewSet, TestDashboardViewSet, TestDeliveryDashboardViewSet
...
dashboard_router.register(r'test-deliveries', TestDeliveryDashboardViewSet, basename='dashboard-test-deliveries')
