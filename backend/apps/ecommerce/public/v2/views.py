...
from .serializers import (
    ProductPublicSerializer, ProductVariantPublicSerializer, ProductCategoryPublicSerializer,
    CartPublicSerializer, CartItemPublicSerializer,
...
class ProductPublicViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @extend_schema(
        ...
        description="List available products for browsing"
    )
...
class CustomerProfilePublicViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @extend_schema(
        ...
        description="Get customer profile (read-only)"
    )
    def retrieve(self, request, *args, **kwargs):
