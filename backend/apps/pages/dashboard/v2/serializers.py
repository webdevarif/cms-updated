...
class PageDashboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'author', 'author_email', 'store', 'store_name',
        ...
        read_only_fields = [
            'id', 'author', 'author_email', 'store', 'store_name',
            'post_type_name', 'created_at', 'updated_at'
        ]
...
class PostTypeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PostType
        fields = [
            'id', 'name', 'slug', 'store', 'is_public', 'is_hierarchical',
            'supports_comments', 'supports_featured_image', 'supports_excerpt',
            'supports_custom_fields', 'supports_categories', 'supports_tags',
            'is_system', 'is_deletable', 'created_at', 'updated_at'
        ]
...
class TermSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Term
        fields = [
            'id', 'name', 'slug', 'taxonomy', 'taxonomy_name',
            'store', 'parent', 'description', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class BulkActionSerializer(serializers.Serializer):
    ...
    action = serializers.ChoiceField(choices=[
        'publish', 'unpublish', 'delete', 'duplicate', 'archive', 'restore',
        'add_tags', 'remove_tags', 'status_change'
    ])
