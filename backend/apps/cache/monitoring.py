...
class CacheMonitor:
    ...
    def check_cache_health():
        ...
        # Check memory usage
        memory_usage_percent = (stats['memory_used'] / stats['memory_peak']) * 100 if stats['memory_peak'] > 0 else 0
        ...
        for key in all_keys[:limit]:
            try:
                ...
                keys_info.append({
                    ...
                    'size_human': CacheMonitor._format_bytes(key_info.get('serializedlength', 0)),
    ...
    def log_cache_metrics():
        ...
        # Log key metrics
        logger.info(f"Cache Metrics - Hits: {stats['hits']}, Misses: {stats['misses']}, "
