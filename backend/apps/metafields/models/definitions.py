...
class MetafieldDefinition(TenantModel):
    ...
    options = models.JSONField(default=list, help_text="Options for select/multiselect fields")
    ...
    # UI Configuration
    ui = models.JSONField(default=dict, help_text="UI configuration (placeholder, help text, etc.)")
