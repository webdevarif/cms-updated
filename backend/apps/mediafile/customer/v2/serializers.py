...
from apps.mediafile.serializers import BaseMediaFileSerializer, BaseMediaFileUploadSerializer, BaseMediaFolderSerializer
...
class MediafileCustomerSerializer(BaseMediaFileSerializer):
    ...
    class Meta(BaseMediaFileSerializer.Meta):
        fields = [
            ...
            'mime_type', 'resource_type', 'imagekit_id', 'width', 'height',
            'alt_text', 'description', 'folder', 'uploaded_by',
...
class MediafolderCustomerSerializer(BaseMediaFolderSerializer):
    ...
    class Meta(BaseMediaFolderSerializer.Meta):
        fields = [
            'id', 'name', 'slug', 'parent', 'path', 'file_count', 'created_at', 'updated_at'
        ]
