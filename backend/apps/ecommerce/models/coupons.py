...
class CouponCampaign(models.Model):
    ...
    store = models.ForeignKey(
        "stores.Store", on_delete=models.CASCADE, related_name="coupon_campaigns"
    )
    ...
    def is_valid(self):
        ...
        return (
            ...
            and (self.total_usage_limit is None or self.used_count < self.total_usage_limit)
        )
...
class Coupon(models.Model):
    ...
    customer = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="coupons"
    )
    ...
    def is_usable(self):
        ...
        return (
            self.status == "active"
            and self.campaign.is_valid
            and (self.customer is None or self.customer == self.customer)
        )
