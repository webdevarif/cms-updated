...
class MetafieldPublicViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @extend_schema(
        ...
        description="List published metafields"
    )
    ...
    @extend_schema(
        summary="Get metafield value",
        description="Get metafield value"
    )
    ...
    @extend_schema(
        summary="Search metafields",
        description="Search metafields by value"
    )
    @action(detail=False, methods=['get'])
