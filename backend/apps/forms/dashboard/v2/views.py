...
from .serializers import DashboardFormSubmissionSerializer, DashboardFormTemplateSerializer
...
class DashboardFormTemplateViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(summary="Get form analytics", description="Get analytics data for a form")
    ...
    def import_form(self, request):
        ...
        imported_form = FormService.import_form_data(
            store=request.store, data=request.data, user=request.user
        )
...
class DashboardFormSubmissionViewSet(viewsets.ModelViewSet):
    ...
    def bulk_update(self, request):
        ...
        updated_count = FormService.bulk_update_submissions(
            submission_ids=submission_ids, updates=updates, store=request.store
        )
