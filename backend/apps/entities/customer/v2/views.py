...
from .serializers import (
    CustomerEntityActionSerializer,
    CustomerEntityInteractionCreateSerializer,
    CustomerEntityInteractionSerializer,
)
...
class CustomerEntityActionViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        queryset = EntityAction.objects.filter(is_active=True).select_related("store")
    ...
    def my_interactions(self, request, pk=None):
        ...
        interactions = EntityInteraction.objects.filter(
            action=entity_action, user=request.user, is_active=True
        ...
        for interaction in queryset:
            ...
            if interaction.rating:
                ...
                summary[action_slug]["average_rating"] = (
                    summary[action_slug]["total_rating"] / summary[action_slug]["count"]
                )
