...
class BaseMediaFileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'mime_type', 'resource_type', 'storage_path', 'imagekit_id', 'width', 'height',
            'alt_text', 'description', 'metadata', 'folder', 'uploaded_by',
            'is_image', 'is_video', 'is_document', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'file_size', 'file_size_formatted', 'mime_type', 'resource_type',
            'storage_path', 'imagekit_id', 'width', 'height', 'uploaded_by',
            'is_image', 'is_video', 'is_document', 'created_at', 'updated_at'
        ]
...
class BaseMediaFileUploadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MediaFile
        fields = [
            'file', 'original_filename', 'alt_text', 'description', 'folder'
        ]
...
class BaseMediaFolderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MediaFolder
        fields = [
            'id', 'name', 'slug', 'store', 'parent', 'created_by', 'path',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'slug', 'store', 'created_by', 'path', 'created_at', 'updated_at'
        ]
