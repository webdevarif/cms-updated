"""
API views for metafields module.
"""
...
from .serializers import MetafieldDefinitionSerializer, MetafieldSerializer


class MetafieldRateThrottle(UserRateThrottle):
    scope = 'metafields'
...
class MetafieldDefinitionViewSet(viewsets.ModelViewSet):
    ...
    throttle_classes = [MetafieldRateThrottle, AnonRateThrottle]
    ...
    def perform_create(self, serializer):
        from ..services import MetafieldService
    ...
    @extend_schema(
        ...
        responses={200: MetafieldDefinitionSerializer(many=True)}
    )
    ...
    @extend_schema(
        ...
        request=MetafieldDefinitionSerializer,
        responses={200: MetafieldDefinitionSerializer}
    )
