...
export default function PageDetailPage({ params }: { params: Promise<{ id: string; locale: string; pageid: string }> }) {
  ...
  // Initialize form when page data is available
  if (page && !title && !isEditing) {
    setTitle(page.title);
    setSlug(page.slug || '');
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updatePage(pageId, result as unknown as Partial<Post>);
      setIsEditing(false);
    } catch (error) {
