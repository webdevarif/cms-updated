...
class Taxonomy(models.Model):
    ...
    store = models.ForeignKey('stores.Store', on_delete=models.CASCADE, related_name='taxonomies')
...
class Term(models.Model):
    ...
    store = models.ForeignKey('stores.Store', on_delete=models.CASCADE, related_name='terms')
    name = models.CharField(max_length=100)
    slug = models.SlugField(max_length=100)
