...
class MetafieldCustomerViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(summary="List metafields", description="List metafields for user's content")
    def list(self, request, *args, **kwargs):
        """List metafields"""
        return super().list(request, *args, **kwargs)

    @extend_schema(summary="Create metafield", description="Create new metafield for content")
