    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_collections', to='auth.user')),
                ('products', models.ManyToManyField(related_name='collections', through='ecommerce.CollectionProduct', to='ecommerce.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_profiles', to='stores.store')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ecommerce_profile', to='auth.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coupon_campaigns', to='stores.store')),
            ],
            options={
                'db_table': 'ecommerce_coupon_campaign',
                'indexes': [
                    models.Index(fields=['store', 'is_active'], name='ecommerc_store__is_active_8a1c8f_idx'),
                    models.Index(fields=['starts_at', 'ends_at'], name='ecommerc_starts_at__ends_at_8a1c8f_idx'),
                ],
                'ordering': ['-created_at'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coupons', to='ecommerce.couponcampaign')),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coupons', to='auth.user')),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coupons', to='ecommerce.order')),
            ],
            options={
                'db_table': 'ecommerce_coupon',
                'indexes': [
                    models.Index(fields=['campaign', 'code'], name='ecommerc_campaign__code_8a1c8f_idx'),
                    models.Index(fields=['customer', 'status'], name='ecommerc_customer__status_8a1c8f_idx'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255)),
                ('method_type', models.CharField(choices=[('credit_card', 'Credit Card'), ('debit_card', 'Debit Card'), ('bank_transfer', 'Bank Transfer'), ('paypal', 'PayPal'), ('stripe', 'Stripe'), ('cash_on_delivery', 'Cash on Delivery'), ('bank_deposit', 'Bank Deposit')], max_length=50)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='auth.user')),
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['store', 'status'], name='ecommerc_store__status_8a1c8f_idx'),
                    models.Index(fields=['customer', 'status'], name='ecommerc_customer__status_8a1c8f_idx'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_variant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_items', to='ecommerce.productvariant')),
            ],
            options={
                'db_table': 'ecommerce_order_item',
                'indexes': [
                    models.Index(fields=['order', 'product'], name='ecommerc_order__product_8a1c8f_idx'),
                    models.Index(fields=['product', 'created_at'], name='ecommerc_product__created_at_8a1c8f_idx'),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments', to='ecommerce.paymentmethod')),
            ],
            options={
                'db_table': 'ecommerce_payment',
                'indexes': [
                    models.Index(fields=['order', 'status'], name='ecommerc_order__status_8a1c8f_idx'),
                    models.Index(fields=['payment_method', 'status'], name='ecommerc_payment_method__status_8a1c8f_idx'),
                    models.Index(fields=['gateway_transaction_id'], name='ecommerc_gateway_transaction_id_5b8c5c_idx'),
                    models.Index(fields=['created_at'], name='ecommerc_created_at_5b8c5c_idx'),
                ],
                'ordering': ['-created_at'],
            },
